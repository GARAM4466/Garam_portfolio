...
function hmac(payloadB64: string): string {
  return base64url(createHmac("sha256", AUTH_SECRET).update(payloadB64).digest());
}
...
// Extract a bearer token from a Node/Vercel header value (string | string[] | undefined).
export function getBearer(value: string | string[] | undefined): string | undefined {
